...
// @grant              unsafeWindow
// @noframes
// @downloadURL https://update.sleazyfork.org/scripts/432150/Pixiv%20Downloader.user.js
// @updateURL https://update.sleazyfork.org/scripts/432150/Pixiv%20Downloader.meta.js
// ==/UserScript==
...
`;
  ...
  var root_1$8 = /* @__PURE__ */ template(`<header class="modal-header text-2xl font-bold"></header> <article class="modal-body mt-4"><h4 class=" text-xl mt-2">修复</h4> <ul class="list-disc list-inside leading-loose"><li>fix(gelbooru): Image broken due to missing referer.</li></ul></article> <footer class="modal-footer mt-4"><div class="flex justify-between items-center text-sm"><button> </button> <a target="_blank" href="https://github.com/drunkg00se/Pixiv-Downloader/issues"> </a></div> <div><div class="flex justify-center items-center min-h-0 gap-14 overflow-hidden"><img alt="credit" class="rounded-full"> <p class="flex flex-col h-full justify-evenly"><a href="https://github.com/drunkg00se/Pixiv-Downloader" target="_blank" class="anchor"> </a> <span> </span></p></div></div></footer>`, 1);
  function Changelog($$anchor, $$props) {
    ...
    ModalWrapper($$anchor, {
      ...
      children: ($$anchor2, $$slotProps) => {
        ...
        header.textContent = `Pixiv Downloader ${"1.12.2"}`;
  ...
  */
  ...
  function App($$anchor, $$props) {
    ...
    onMount(() => {
      ...
      if (clientSetting.version !== "1.12.2") {
        clientSetting.version = "1.12.2";
        showChangelog();
      }
  ...
  class E621ngApi extends ApiBase {
    constructor(option) {
      ...
      const UA = `Pixiv Downloader/${"1.12.2"} (by drunkg00se on e621)`;
